...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex justify-center bg-[#f5f2e8]/80 backdrop-blur-sm border-b border-secondary/20">
      <div className="flex items-center justify-between whitespace-nowrap px-6 sm:px-12 lg:px-16 py-4 w-full max-w-7xl">
        <Link href="/" className="flex items-center gap-3 text-primary hover:opacity-80 transition-opacity">
          ...
          <h2 className="text-[#1f1f1f] text-xl font-bold font-serif leading-tight tracking-[-0.015em]">Suhaani Henna</h2>
        </Link>
